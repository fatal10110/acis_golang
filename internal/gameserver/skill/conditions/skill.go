...
func (c SkillStats) Test(effector, effected Actor, skill Skill) bool {
	return skill != nil && skill.Stat() == c.Stat
}
...
func (c UsingItemType) Test(effector, effected Actor, skill Skill) bool {
