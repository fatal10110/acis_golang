...
// Location is a 3D (x/y/z) world point (Location.java). Partial port: the
// Java class is mutable, extends Point2D and carries geometry helpers;
// those come with the actor/movement work that needs them.
