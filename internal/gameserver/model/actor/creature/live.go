...
func NewLive(origin location.Location, speed float64, geo move.Geo, owner effect.StatOwner, opts ...effect.Option) (*Live, error) {
	live := &Live{effects: effect.NewList(owner, opts...)}
