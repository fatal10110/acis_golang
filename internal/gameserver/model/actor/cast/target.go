...
func SelectTarget(caster Target, selected world.Tracked, def modelskill.Definition) (Target, bool) {
	switch def.Target {
	case modelskill.TargetNone, modelskill.TargetSelf, modelskill.TargetGround:
		return caster, caster != nil
	case modelskill.TargetOne, modelskill.TargetHoly, modelskill.TargetUnlockable:
