...
func (f *fakeCombatant) CharacterName() string                      { return "" }
...
func (f *fakeCombatant) EffectRangeInPeaceZone(x, y, z, r int) bool { return false }
func (f *fakeCombatant) Knows(Combatant) bool                       { return true }
